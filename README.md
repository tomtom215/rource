...
|------|------------|----------|--------|
| **Verus** | Vec2, Vec3, Vec4, Mat3, Mat4, Color, Rect | 426 proof functions, 452+ VCs | Verified |
| **Coq (R-based)** | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType | 925 theorems | Zero admits |
...
| **Combined** | All 8 core math types + Bounds + FP layer + CrossType | **1963 theorems/harnesses** | **TRIPLE VERIFIED** |
...
| Document | Description |
|----------|-------------|
| [docs/verification/FORMAL_VERIFICATION.md](docs/verification/FORMAL_VERIFICATION.md) | 1963 formally verified theorems (Verus + Coq) |
