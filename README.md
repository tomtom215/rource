...
| **Combined** | All 8 core math types + Bounds + FP layer + CrossType | **2856 theorems/harnesses** | **TRIPLE VERIFIED** |
...
| Document | Description |
|----------|-------------|
| [docs/verification/FORMAL_VERIFICATION.md](docs/verification/FORMAL_VERIFICATION.md) | 2856 formally verified theorems (Verus + Coq) |
