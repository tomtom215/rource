...
| **Coq (R-based)** | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType | 1139 theorems | Zero admits |
...
| **Combined** | All 8 core math types + Bounds + FP layer + CrossType | **2629 theorems/harnesses** | **TRIPLE VERIFIED** |
...
| Document | Description |
|----------|-------------|
| [docs/verification/FORMAL_VERIFICATION.md](docs/verification/FORMAL_VERIFICATION.md) | 2629 formally verified theorems (Verus + Coq) |
