...
| **Combined** | All 8 core math types + Bounds + FP layer + CrossType | **2222 theorems/harnesses** | **TRIPLE VERIFIED** |
...
| Document | Description |
|----------|-------------|
| [docs/verification/FORMAL_VERIFICATION.md](docs/verification/FORMAL_VERIFICATION.md) | 2222 formally verified theorems (Verus + Coq) |
