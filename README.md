...
| **Coq (R-based)** | Vec2-4, Mat3-4, Color, Rect, Utils + Complexity | 497 theorems | ✅ Zero admits |
...
| Document | Description |
|----------|-------------|
| [docs/verification/FORMAL_VERIFICATION.md](docs/verification/FORMAL_VERIFICATION.md) | 1308 formally verified theorems (Verus + Coq) |
