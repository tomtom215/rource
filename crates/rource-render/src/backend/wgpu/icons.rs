//! Procedural file icon generator.
//!
//! This module generates simple, visually distinct icons for different file
//! extensions. Icons are 32x32 RGBA images that can be used with the texture
//! array for batched rendering.
//!
//! # Icon Design
//!
...
//!
//! let icon_data = generate_icon(0xDEA584FF); // Rust orange
