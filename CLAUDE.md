...
- **Coq (R-based)**: 1065 theorems, 0 admits, machine-checked (Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType)
- **Coq (Z-based)**: 391 theorems, 0 admits, machine-checked (extractable computational bridge, 9 types)
- **Coq (FP error bounds)**: 279 theorems, 0 admits, machine-checked (Flocq 4.1.3 IEEE 754 binary32 error analysis)
- **Kani (CBMC)**: 203 proof harnesses, 0 failures, bit-precise IEEE 754 f32 verification
- **Combined**: 2413 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2413 theorems/harnesses) |
...
| `docs/verification/COQ_PROOFS.md` | Coq proofs (R + Z, 1456 theorems, development workflow) |
...
|-----------|-------|---------------|-----------------|-------------|-------|--------|
| Vec2 | 55 proof fns | 120 theorems | 50 theorems | 25 harnesses | 250 | TRIPLE VERIFIED |
...
| Mat3 | 48 proof fns | 92 theorems | 25 theorems | 21 harnesses | 186 | TRIPLE VERIFIED |
...
| Rect | 52 proof fns | 130 theorems | 43 theorems | 25 harnesses | 250 | TRIPLE VERIFIED |
...
| FP Foundations | — | — (FP layer) | — | — | 279 | MACHINE-CHECKED |
| **Total** | **475 proof fns** | **1065 theorems** | **391 theorems** | **203 harnesses** | **2413** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2413 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2413 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2413 theorems/harnesses (Verus: 475, Coq R-based: 1065, Coq Z-based: 391, Coq FP: 279, Kani: 203)*
