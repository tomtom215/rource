...
- **Coq (R-based)**: 1057 theorems, 0 admits, machine-checked (Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType)
...
- **Combined**: 2405 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2405 theorems/harnesses) |
...
| `docs/verification/COQ_PROOFS.md` | Coq proofs (R + Z, 1448 theorems, development workflow) |
...
|-----------|-------|---------------|-----------------|-------------|-------|--------|
| Vec2 | 55 proof fns | 115 theorems | 50 theorems | 25 harnesses | 245 | TRIPLE VERIFIED |
...
| Rect | 52 proof fns | 127 theorems | 43 theorems | 25 harnesses | 247 | TRIPLE VERIFIED |
...
| **Total** | **475 proof fns** | **1057 theorems** | **391 theorems** | **203 harnesses** | **2405** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2405 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2405 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2405 theorems/harnesses (Verus: 475, Coq R-based: 1057, Coq Z-based: 391, Coq FP: 279, Kani: 203)*
