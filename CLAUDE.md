...
- **Kani (CBMC)**: 214 proof harnesses, 0 failures, bit-precise IEEE 754 f32 verification
- **Combined**: 2508 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2508 theorems/harnesses) |
...
|-----------|-------|---------------|-----------------|-------------|-------|--------|
| Vec2 | 55 proof fns | 121 theorems | 50 theorems | 27 harnesses | 253 | TRIPLE VERIFIED |
| Vec3 | 55 proof fns | 115 theorems | 42 theorems | 28 harnesses | 240 | TRIPLE VERIFIED |
...
| Mat4 | 54 proof fns | 157 theorems | 50 theorems | 28 harnesses | 289 | TRIPLE VERIFIED |
...
| **Total** | **475 proof fns** | **1072 theorems** | **391 theorems** | **214 harnesses** | **2508** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2508 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2508 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2508 theorems/harnesses (Verus: 475, Coq R-based: 1072, Coq Z-based: 391, Coq FP: 356, Kani: 214)*
