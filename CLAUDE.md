...
- **Coq (R-based)**: 1072 theorems, 0 admits, machine-checked (Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType)
...
- **Combined**: 2514 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2514 theorems/harnesses) |
...
| `docs/verification/COQ_PROOFS.md` | Coq proofs (R + Z, 1463 theorems, development workflow) |
...
|-----------|-------|---------------|-----------------|-------------|-------|--------|
| Vec2 | 55 proof fns | 121 theorems | 50 theorems | 29 harnesses | 255 | TRIPLE VERIFIED |
...
| **Total** | **475 proof fns** | **1072 theorems** | **391 theorems** | **220 harnesses** | **2514** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2514 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2514 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2514 theorems/harnesses (Verus: 475, Coq R-based: 1072, Coq Z-based: 391, Coq FP: 356, Kani: 220)*
