...
- **Coq (R-based)**: 1208 theorems, 0 admits, machine-checked (Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType)
...
- **Combined**: 2698 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2698 theorems/harnesses) |
...
| `docs/verification/COQ_PROOFS.md` | Coq proofs (R + Z, 1637 theorems, development workflow) |
...
| **Total** | **475 proof fns** | **1208 theorems** | **429 theorems** | **225 harnesses** | **2698** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2698 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2698 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2698 theorems/harnesses (Verus: 475, Coq R-based: 1208, Coq Z-based: 429, Coq FP: 361, Kani: 225)*
