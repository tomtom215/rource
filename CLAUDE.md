...
- **Kani (CBMC)**: 177 proof harnesses, 0 failures, bit-precise IEEE 754 f32 verification
- **Combined**: 2222 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2222 theorems/harnesses) |
...
| **Total** | **475 proof fns** | **1024 theorems** | **369 theorems** | **177 harnesses** | **2222** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2222 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2222 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2222 theorems/harnesses (Verus: 475, Coq R-based: 1024, Coq Z-based: 369, Coq FP: 177, Kani: 177)*
