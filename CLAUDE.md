...
- **Coq (R-based)**: 1081 theorems, 0 admits, machine-checked (Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType)
- **Coq (Z-based)**: 391 theorems, 0 admits, machine-checked (extractable computational bridge, 9 types)
- **Coq (FP error bounds)**: 356 theorems, 0 admits, machine-checked (Flocq 4.1.3 IEEE 754 binary32 error analysis)
- **Kani (CBMC)**: 220 proof harnesses, 0 failures, bit-precise IEEE 754 f32 verification
- **Combined**: 2523 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2523 theorems/harnesses) |
...
| `docs/verification/COQ_PROOFS.md` | Coq proofs (R + Z, 1472 theorems, development workflow) |
...
|-----------|-------|---------------|-----------------|-------------|-------|--------|
| Vec2 | 55 proof fns | 130 theorems | 50 theorems | 29 harnesses | 264 | TRIPLE VERIFIED |
| Vec3 | 55 proof fns | 115 theorems | 42 theorems | 29 harnesses | 241 | TRIPLE VERIFIED |
| Vec4 | 55 proof fns | 96 theorems | 33 theorems | 24 harnesses | 208 | TRIPLE VERIFIED |
| Mat3 | 48 proof fns | 102 theorems | 25 theorems | 24 harnesses | 199 | TRIPLE VERIFIED |
| Mat4 | 54 proof fns | 157 theorems | 50 theorems | 29 harnesses | 290 | TRIPLE VERIFIED |
...
| FP Foundations | — | — (FP layer) | — | — | 356 | MACHINE-CHECKED |
| **Total** | **475 proof fns** | **1081 theorems** | **391 theorems** | **220 harnesses** | **2523** | **ACADEMIC** |
...
- History: `docs/verification/VERIFICATION_CHRONOLOGY.md`
- Roadmap: `docs/verification/VERIFICATION_FUTURE_WORK.md`
...
| **Formal Verification** | Verus + Coq + Kani proofs (2523 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2523 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2523 theorems/harnesses (Verus: 475, Coq R-based: 1081, Coq Z-based: 391, Coq FP: 356, Kani: 220)*
