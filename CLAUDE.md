...
- **Coq (R-based)**: 1056 theorems, 0 admits, machine-checked (Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType)
...
- **Kani (CBMC)**: 200 proof harnesses, 0 failures, bit-precise IEEE 754 f32 verification
- **Combined**: 2401 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2401 theorems/harnesses) |
...
| `docs/verification/COQ_PROOFS.md` | Coq proofs (R + Z, 1447 theorems, development workflow) |
...
| **Total** | **475 proof fns** | **1056 theorems** | **391 theorems** | **200 harnesses** | **2401** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2401 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2401 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2401 theorems/harnesses (Verus: 475, Coq R-based: 1056, Coq Z-based: 391, Coq FP: 279, Kani: 200)*
