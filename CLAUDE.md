...
- **Kani (CBMC)**: 223 proof harnesses, 0 failures, bit-precise IEEE 754 f32 verification
- **Combined**: 2537 formally verified theorems/harnesses across 10 types + FP layer
...
| `docs/verification/FORMAL_VERIFICATION.md` | Formal verification overview and index (2537 theorems/harnesses) |
...
| **Total** | **475 proof fns** | **1078 theorems** | **400 theorems** | **223 harnesses** | **2537** | **ACADEMIC** |
...
| **Formal Verification** | Verus + Coq + Kani proofs (2537 theorems/harnesses), zero admits, triple verification for Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + FP error bounds |
...
│                                                                             │
│  2537 formally verified theorems/harnesses across Verus + Coq + Kani        │
...
*Formal Verification: 2537 theorems/harnesses (Verus: 475, Coq R-based: 1078, Coq Z-based: 400, Coq FP: 361, Kani: 223)*
