...
| **Coq** | Mathematical proofs, complexity | Production | Active (1637 theorems) |
...
| **ICC/Coq** | Complexity bounds | Research | Active (1637 theorems) |
...
|----------|--------|-----------|
| **Current** | Stay on Coq 8.18 + MetaCoq (built from source) | Working, tested, 1637 theorems compile |
