...
| **Coq** | Mathematical proofs, complexity | Production | Active (1512 theorems) |
...
| **ICC/Coq** | Complexity bounds | Research | Active (1512 theorems) |
...
|----------|--------|-----------|
| **Current** | Stay on Coq 8.18 + MetaCoq (built from source) | Working, tested, 1512 theorems compile |
