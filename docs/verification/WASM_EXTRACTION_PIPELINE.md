...
| **Coq** | Mathematical proofs, complexity | Production | Active (1689 theorems) |
...
| **ICC/Coq** | Complexity bounds | Research | Active (1689 theorems) |
...
|----------|--------|-----------|
| **Current** | Stay on Coq 8.18 + MetaCoq (built from source) | Working, tested, 1689 theorems compile |
