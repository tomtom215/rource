...
| **Coq** | Mathematical proofs, complexity | Production | Active (1448 theorems) |
...
| **ICC/Coq** | Complexity bounds | Research | Active (1448 theorems) |
...
|----------|--------|-----------|
| **Current** | Stay on Coq 8.18 + MetaCoq (built from source) | Working, tested, 1448 theorems compile |
