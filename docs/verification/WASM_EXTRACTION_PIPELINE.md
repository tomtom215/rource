...
| **Coq** | Mathematical proofs, complexity | Production | Active (1327 theorems) |
...
| **ICC/Coq** | Complexity bounds | Research | Active (1327 theorems) |
...
|----------|--------|-----------|
| **Current** | Stay on Coq 8.18 + MetaCoq (built from source) | Working, tested, 1327 theorems compile |
