...
|-------|----------|--------------------|----|
| Current | 69.8% (178/255) | Algebraic + edge-case properties | 2629 theorems/harnesses |
| **Phase FP-1 foundations** | **69.8%** | **+ FP error bounds, rounding, vec ops (361 FP theorems)** | **2629** |
