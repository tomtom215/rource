...
|-------|----------|--------------------|----|
| Current | 80.4% (205/255) | Algebraic + edge-case properties | 2856 theorems/harnesses |
| **Phase FP-1 foundations** | **80.4%** | **+ FP error bounds, rounding, vec ops (361 FP theorems)** | **2856** |
| After Phase FP-2 | ~85% (217/255) | + sqrt, rounding, min/max, lerp, distance_sq | ~2856 |
