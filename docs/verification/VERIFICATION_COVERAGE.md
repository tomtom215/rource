...
Our 1438 existing Coq theorems use Coq 8.18. The generated code targets Rocq 9.0.
...
| Compilability | Blocked (infra) | All 1438 Coq theorems compile |
...
with manual correspondence to Rust implementations, verified by 1438 machine-checked
Coq theorems (980 R-based + 359 Z-based + 99 FP) with zero admits. The spec-to-implementation gap is documented as a known
...
```
Current (3-layer):  Verus (algebra) + Coq (proofs) + Kani (IEEE 754)  → 2085 theorems, 59.3% ops
