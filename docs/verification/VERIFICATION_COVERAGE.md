...
```
Current (3-layer):  Verus (algebra) + Coq (proofs) + Kani (IEEE 754)  → 2537 theorems, 59.3% ops
...
| **Total** | **223** | **All verified, 0 failures** |
...
*Kani IEEE 754 harnesses: 223 (all verified, 0 failures)*
