...
```
Current (3-layer):  Verus (algebra) + Coq (proofs) + Kani (IEEE 754)  → 1963 theorems, 59.3% ops
...
| **Total** | **154** | **All verified, 0 failures** |
...
*Kani IEEE 754 harnesses: 154 (all verified, 0 failures)*
