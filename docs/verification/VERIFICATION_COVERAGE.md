...
```
Current (3-layer):  Verus (algebra) + Coq (proofs) + Kani (IEEE 754)  → 2541 theorems, 59.3% ops
...
| **Total** | **227** | **All verified, 0 failures** |
...
*Kani IEEE 754 harnesses: 227 (all verified, 0 failures)*
