...
| **Coq** | 8.18.0 | Proof assistant (1726 theorems: 1056 R-based + 391 Z-based + 279 FP) | System (`apt`) + opam (see Rocq migration) |
...
| **Total** | **32 files** | **1447** | **Zero admits** |
...
| Coq (R-based) | 1056 theorems | 0 | 0 |
| Coq (Z-based) | 391 theorems | 0 | 0 |
| Kani (CBMC) | 200 harnesses | 0 | 0 |
| **Combined** | **2401** | **0** | **0** |
...
*2401 formally verified theorems/harnesses (Verus: 475, Coq: 1726, Kani: 200)*
