...
| **Coq** | 8.18.0 | Proof assistant (1735 theorems: 1065 R-based + 391 Z-based + 279 FP) | System (`apt`) + opam (see Rocq migration) |
...
| 1 (Proof) | `Vec2_Proofs.v` | 120 | Vec2 algebraic properties |
...
| 1 (Proof) | `Rect_Proofs.v` | 130 | Rect containment, intersection, union |
...
| **Total** | **32 files** | **1456** | **Zero admits** |
...
| Coq (R-based) | 1065 theorems | 0 | 0 |
| Coq (Z-based) | 391 theorems | 0 | 0 |
| Kani (CBMC) | 203 harnesses | 0 | 0 |
| **Combined** | **2413** | **0** | **0** |
...
*2413 formally verified theorems/harnesses (Verus: 475, Coq: 1735, Kani: 203)*
