...
| **Coq** | 8.18.0 | Proof assistant (1560 theorems: 1024 R-based + 359 Z-based + 177 FP) | System (`apt`) + opam (see Rocq migration) |
...
| **Total** | **32 files** | **1383** | **Zero admits** |
...
*2207 formally verified theorems/harnesses (Verus: 475, Coq: 1560, Kani: 172)*
