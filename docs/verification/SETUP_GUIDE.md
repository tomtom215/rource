...
| **Coq** | 8.18.0 | Proof assistant (1727 theorems: 1057 R-based + 391 Z-based + 279 FP) | System (`apt`) + opam (see Rocq migration) |
...
| 1 (Proof) | `Vec2_Proofs.v` | 115 | Vec2 algebraic properties |
...
| 1 (Proof) | `Rect_Proofs.v` | 127 | Rect containment, intersection, union |
...
| **Total** | **32 files** | **1448** | **Zero admits** |
...
*2405 formally verified theorems/harnesses (Verus: 475, Coq: 1727, Kani: 203)*
