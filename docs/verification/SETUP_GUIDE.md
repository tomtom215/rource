...
| **Coq** | 8.18.0 | Proof assistant (2156 theorems: 1366 R-based + 429 Z-based + 361 FP) | System (`apt`) + opam (see Rocq migration) |
...
| **Total** | **32 files** | **1795** | **Zero admits** |
...
*2856 formally verified theorems/harnesses (Verus: 475, Coq: 2156, Kani: 225)*
