...
| **Coq** (R-based abstract) | 1072 theorems | 0 | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType | Machine-checked |
...
| **Combined** | **2514** | **0** | **10 types + FP** | **PEER REVIEWED PUBLISHED ACADEMIC** |
...
| **Total** | **475 proof fns** | **1072 theorems** | **391 theorems** | **356 theorems** | **220 harnesses** | **2514** | **ACADEMIC** |
...
|       |                                                                   |
|       +---> Manual Coq Specs --> Coq Proofs (1463 theorems)               |
|       |                                |                                  |
...
# Coq proofs (1463 theorems, ~45s total)
cd crates/rource-math/proofs/coq

# Layer 1: Specs + Proofs + Complexity + CrossType (1072 R-based theorems)
...
1. **First triple-verified Rust graphics library**: rource-math with 2514 machine-checked proofs/harnesses across 10 types + cross-type (Verus + Coq + Kani)
...
*Total theorems/harnesses: 2514 across Verus, Coq, and Kani (Verus: 475, Coq R-based: 1072, Coq Z-based: 391, Coq FP: 177, Kani: 220)*
*Total admits: 0*
