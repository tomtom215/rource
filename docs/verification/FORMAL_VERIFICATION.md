...
| **Combined** | **1057** | **0** | **8 types** | **PEER REVIEWED PUBLISHED ACADEMIC** |
...
1. **First triple-verified Rust graphics library**: rource-math with 1057 machine-checked proofs/harnesses across 8 types (Verus + Coq + Kani)
...
*Total theorems/harnesses: 1057 across Verus, Coq, and Kani (Verus: 266, Coq R-based: 446, Coq Z-based: 235, Kani: 110)*
*Total admits: 0*
