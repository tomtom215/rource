...
| **Coq** (R-based abstract) | 1095 theorems | 0 | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType | Machine-checked |
| **Coq** (Z-based extractable) | 417 theorems | 0 | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils | Machine-checked |
...
| **Combined** | **2573** | **0** | **10 types + FP** | **PEER REVIEWED PUBLISHED ACADEMIC** |
...
| **Total** | **475 proof fns** | **1095 theorems** | **417 theorems** | **361 theorems** | **225 harnesses** | **2573** | **ACADEMIC** |
...
|       |                                                                   |
|       +---> Manual Coq Specs --> Coq Proofs (1512 theorems)               |
|       |                                |                                  |
|       |                                +---> ICC --> Complexity Bounds    |
|       |                                |            O(1) proofs (60)     |
|       |                                |                                  |
|       |                                +---> Z-based Computational Bridge |
|       |                                |    9 Compute files (417 thms)   |
|       |                                |         |                       |
...
# Coq proofs (1512 theorems, ~45s total)
cd crates/rource-math/proofs/coq

# Layer 1: Specs + Proofs + Complexity + CrossType (1095 R-based theorems)
...
# Layer 2: Z-based Computational Bridge (417 theorems)
...
1. **First triple-verified Rust graphics library**: rource-math with 2573 machine-checked proofs/harnesses across 10 types + cross-type (Verus + Coq + Kani)
...
**Coverage summary**: 170/255 public operations verified (66.7%).
...
*9 Compute files: Vec2(56), Vec3(48), Vec4(39), Mat3(25), Mat4(50), Color(60), Rect(51), Bounds(70), Utils(18) = 417 theorems over Z*
...
*Total theorems/harnesses: 2573 across Verus, Coq, and Kani (Verus: 475, Coq R-based: 1095, Coq Z-based: 417, Coq FP: 361, Kani: 225)*
*Total admits: 0*
*Verified types: Vec2, Vec3, Vec4, Mat3, Mat4, Color, Rect, Bounds, Utils + CrossType*
*Verified operations: 170/255 (66.7%) — see VERIFICATION_COVERAGE.md for per-module breakdown*
