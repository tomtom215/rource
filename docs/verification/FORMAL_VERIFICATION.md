...
| **Coq** (R-based abstract) | 1139 theorems | 0 | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType | Machine-checked |
...
| **Combined** | **2629** | **0** | **10 types + FP** | **PEER REVIEWED PUBLISHED ACADEMIC** |

## Per-Type Verification Summary

| Component | Verus | Coq (R-based) | Coq (Z-Compute) | Coq (FP) | Kani (CBMC) | Total | Status |
|-----------|-------|---------------|-----------------|----------|-------------|-------|--------|
| Vec2 | 55 proof fns | 133 theorems | 62 theorems | — | 28 harnesses | 278 | TRIPLE VERIFIED |
| Vec3 | 55 proof fns | 127 theorems | 54 theorems | — | 29 harnesses | 265 | TRIPLE VERIFIED |
...
| Utils | 33 proof fns | 57 theorems | 18 theorems | — | 11 harnesses | 119 | TRIPLE VERIFIED |
| Complexity | — | 60 theorems | — | — | — | 60 | VERIFIED |
| CrossType | — | 51 theorems | — | — | — | 51 | VERIFIED |
| FP Foundations | — | — | — | 361 theorems | — | 361 | MACHINE-CHECKED |
| **Total** | **475 proof fns** | **1139 theorems** | **429 theorems** | **361 theorems** | **225 harnesses** | **2629** | **ACADEMIC** |
...
|       |                                                                   |
|       +---> Manual Coq Specs --> Coq Proofs (1568 theorems)               |
|       |                                |                                  |
...
# Coq proofs (1568 theorems, ~45s total)
cd crates/rource-math/proofs/coq

# Layer 1: Specs + Proofs + Complexity + CrossType (1139 R-based theorems)
...
1. **First triple-verified Rust graphics library**: rource-math with 2629 machine-checked proofs/harnesses across 10 types + cross-type (Verus + Coq + Kani)
...
*Total theorems/harnesses: 2629 across Verus, Coq, and Kani (Verus: 475, Coq R-based: 1139, Coq Z-based: 429, Coq FP: 361, Kani: 225)*
*Total admits: 0*
