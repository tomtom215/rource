...
| **Coq** (R-based abstract) | 1208 theorems | 0 | Vec2-4, Mat3-4, Color, Rect, Bounds, Utils + Complexity + CrossType | Machine-checked |
...
| **Combined** | **2698** | **0** | **10 types + FP** | **PEER REVIEWED PUBLISHED ACADEMIC** |
...
| Mat4 | 54 proof fns | 180 theorems | 50 theorems | — | 32 harnesses | 316 | TRIPLE VERIFIED |
| Color | 57 proof fns | 129 theorems | 60 theorems | — | 25 harnesses | 271 | TRIPLE VERIFIED |
| Rect | 52 proof fns | 152 theorems | 51 theorems | — | 27 harnesses | 282 | TRIPLE VERIFIED |
| Bounds | 66 proof fns | 107 theorems | 70 theorems | — | 25 harnesses | 268 | TRIPLE VERIFIED |
...
| **Total** | **475 proof fns** | **1208 theorems** | **429 theorems** | **361 theorems** | **225 harnesses** | **2698** | **ACADEMIC** |
...
|       |                                                                   |
|       +---> Manual Coq Specs --> Coq Proofs (1637 theorems)               |
|       |                                |                                  |
...
# Coq proofs (1637 theorems, ~45s total)
cd crates/rource-math/proofs/coq

# Layer 1: Specs + Proofs + Complexity + CrossType (1208 R-based theorems)
...
1. **First triple-verified Rust graphics library**: rource-math with 2698 machine-checked proofs/harnesses across 10 types + cross-type (Verus + Coq + Kani)
...
**Coverage summary**: 178/255 public operations verified (69.8%).
...
*Version: Coq 8.18*
*Total theorems: 1139 (Vec2: 133, Vec3: 127, Vec4: 96, Mat3: 102, Mat4: 180, Color: 129, Rect: 152, Bounds: 107, Complexity: 60, CrossType: 51, Utils: 59)*
*Admits: 0*
...
*Total theorems/harnesses: 2698 across Verus, Coq, and Kani (Verus: 475, Coq R-based: 1208, Coq Z-based: 429, Coq FP: 361, Kani: 225)*
*Total admits: 0*
*Verified types: Vec2, Vec3, Vec4, Mat3, Mat4, Color, Rect, Bounds, Utils + CrossType*
*Verified operations: 178/255 (69.8%) — see VERIFICATION_COVERAGE.md for per-module breakdown*
