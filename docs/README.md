...
| [performance/CHRONOLOGY.md](./performance/CHRONOLOGY.md) | Timeline of all **88 optimization phases** |
...
| Document | Description |
|----------|-------------|
| [verification/FORMAL_VERIFICATION.md](./verification/FORMAL_VERIFICATION.md) | Formal verification overview and index (2968 theorems/harnesses, 9 types) |
...
4. [performance/CHRONOLOGY.md](./performance/CHRONOLOGY.md) - 88 optimization phases
