...
| Document | Description |
|----------|-------------|
| [verification/FORMAL_VERIFICATION.md](./verification/FORMAL_VERIFICATION.md) | Formal verification overview and index (1815 theorems/harnesses, 8 types) |
| [verification/VERUS_PROOFS.md](./verification/VERUS_PROOFS.md) | Verus theorem tables (327 proof functions, 7 types) |
| [verification/COQ_PROOFS.md](./verification/COQ_PROOFS.md) | Coq proofs (R-based + Z-based, 1255 theorems, development workflow) |
